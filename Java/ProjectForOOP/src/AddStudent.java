 ...
 //heading
       ...
       rollNum.setFont(new Font("serif",Font.BOLD,20));
        add(rollNum);
         ...
         labelrollNum = new JLabel("21sw"+first4);
...
//Cource label
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource()==submit){
            ...
            String rollNumG = labelrollNum.getText();
            ...
            String courceg = (String)cource.getSelectedItem();
            String branchg = (String)branch.getSelectedItem();

            try {
                String query = "insert into student values('"+nameg+"','"+fatherg+"','"+rollNumG+"','"+DoB+"','"+addresg+"','"+phoneg+"','"+emailg+"','"+x+"','"+xii+"','"+NIC+"','"+courceg+"','"+branchg+"')";
                Conn con = new Conn();
