...
let countrySuffixString =
  "ica,ina,and,nia,bia,nia,nia,sia,nea,ria,ria,nia,ina,bia,lia,ica,nea,bia,tan,lic,lic,ria,nds,nia,tan,tan,nds,tan,tan,tan,and,and,and,lia,nia,tan,tan,nea,bia,ina,and,sia,sia,sia,nia,ria,rea,lia,ria,ria,bia,and,nia,ica,and,rea,rea,ana,nds,ica,ica,ana,bia,ana,nia,sia";

//convert string to array
let countrySuffixArray = countrySuffixString.split(",");

//sort array for unique values
countrySuffixArray = countrySuffixArray.filter(
  (currentValue, index, array) => array.indexOf(currentValue) === index
); //indexOf returns the first index for the value

/*
countrySuffixArray after being filtered
["ica", "ina", "and", "nia", "bia", "sia", "nea", "ria", "lia", "tan", "lic", "nds", "rea", "ana"]
*/
  ...
  for (let i = 0; i < countrySuffixArray.length; i++) {
    newcountries.push(
      sortedCountries.filter((country) => {
        if (country.name.endsWith(countrySuffixArray[i])) return country;
      })
    );
  }
}
...
//       return country.name.toLowerCase().includes("ia") || country.name.toLowerCase().includes("island") || country.name.toLowerCase().includes("land") || country.name.toLowerCase().includes("stan");
//   })
//   return coun;
// }
